...
// Permitir solicitudes desde cualquier origen , ya que voy a consumir esta api con react, debo configurar estos permisos
header('Access-Control-Allow-Origin: *');
// Permitir los métodos HTTP específicos que desees permitir
header('Access-Control-Allow-Methods: GET, POST, PUT, DELETE, OPTIONS');
// Permitir los encabezados específicos que desees permitir
